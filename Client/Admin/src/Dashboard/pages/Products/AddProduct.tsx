  ...
  export default function AddProduct() {
    ...
    const careInstructionsOptions = [
      ...
      { value: "Tumble Dry Low", icon: Droplet }, // Dummy icon, replace with correct one
    ];
    ...
    const [formData, setFormData] = useState({
      ...
      waterUsage: "",
      energyUsage: "",
      careInstructions: [], // Array to hold multiple care instructions
    });
    ...
    const isStepValid = () => {
      switch (currentStep) {
        ...
        case 4:
          return true; // Optional validation for sustainability step
        case 5:
          return true;
        default:
          return false;
    ...
    const handleCareInstructionChange = (value) => {
      setFormData(prev => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("pefScore", e.target.value)}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("frenchScore", e.target.value)}
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange("productiveDate", e.target.value)}
                  />
                </div>
              </div>
            </div>
